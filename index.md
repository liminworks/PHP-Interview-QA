...
hero:
  name: "PHP 面试问答"
  text: "PHP 中大厂面试题库"
  tagline: "87 道精选题 · L1–L5 难度全覆盖 · 系统化备战面试"
  actions:
    - theme: brand
      text: 按主题浏览 →
      link: /docs/php/
...
features:
  ...
  - icon: 📡
    title: 计算机网络篇
    details: 12 题 · L1–L3 · TCP/HTTP、TLS 握手、HTTP/2 与 HTTP/3 原理
    link: /docs/network/
    linkText: 开始学习
  ...
  - icon: 🖥️
    title: 操作系统与服务器篇
    details: 3 题 · L1/L2/L4 · Linux 命令、PHP-FPM 进程模型、Swoole 选型决策
    link: /docs/server/
    linkText: 开始学习
  ...
  - icon: 📝
    title: 番外篇
    details: 2 题 · L2 · 生产环境 Bug 排查工作流、AI 时代 PHP 开发方法论
    link: /docs/misc/
    linkText: 开始学习
---
